...
namespace DataWranglerInterface.XamlUtility
{
	//https://gist.github.com/angularsen/90040fb174f71c5ab3ad#file-marginsetter-cs
    public class MarginSetter
    {
        ...
        private static void MarginChangedCallback(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (panel.IsLoaded)
            {
                OnPanelLoaded(panel, (RoutedEventArgs)EventArgs.Empty);
            }
        }
